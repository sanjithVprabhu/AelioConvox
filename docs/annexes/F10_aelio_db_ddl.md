# F10 — Aelio DB DDL outline (§24)

**Sources:** §24, App G, App I, App K.
**Note:** aelio-os uses typed row tables; this is the logical schema. Physical mapping uses Aelio DB column kinds (`utf8`, `i64`, `text`, `vector`, …).
