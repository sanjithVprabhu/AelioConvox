...
use ll_index::{distance, Hnsw, HnswParams, Metric, SplitMix64};
...
fn recall_at_10_is_high_on_random_data() {
    ...
    let mut index = Hnsw::new(dim, HnswParams { m: 16, ef_construction: 200, seed: 42, metric });
    for v in &data {
...
fn build_is_deterministic_for_a_seed() {
    ...
    let params = HnswParams { m: 16, ef_construction: 100, seed: 123, metric: Metric::L2 };
